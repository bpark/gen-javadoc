...
/**
 * Action for generating setter and getter documentation.
 *
 * @author Burt Parkers
 */
public class GetterAndSetterDocAction extends EditorAction {

    /** Constructor. */
    public GetterAndSetterDocAction() {
        super(new DocGenHandler());
    }
