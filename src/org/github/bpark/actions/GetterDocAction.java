...
/**
 * Action for generating getter documentation.
 *
 * @author Burt Parkers
 */
public class GetterDocAction extends EditorAction {

    /** Constructor. */
    public GetterDocAction() {
        super(new DocGenHandler(MethodType.GETTER));
    }
