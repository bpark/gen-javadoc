...
/**
 * Action for generating setter documentation.
 *
 * @author Burt Parkers
 */
public class SetterDocAction extends EditorAction {

    /** Constructor. */
    public SetterDocAction() {
        super(new DocGenHandler(MethodType.SETTER));
    }
